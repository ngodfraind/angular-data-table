...
(function (global, factory) {
  ...
  var ColumnSelectorController = (function () {
    function ColumnSelectorController() {
      babelHelpers.classCallCheck(this, ColumnSelectorController);
    }

    babelHelpers.createClass(ColumnSelectorController, [{
      key: "onClick",
      value: function onClick(column) {
        this.isChecked(column) ? this.options.columns.splice(this.getColumnIndex(column), 1) : this.options.columns.push(column);
      }
    }, {
      key: "isChecked",
      value: function isChecked(column) {
    ...
    return ColumnSelectorController;
  })();
  ...
  var SizeSelectorController = (function () {
    SizeSelectorController.$inject = ["$scope"];
    function SizeSelectorController($scope) {
  ...
  var DataTableController = (function () {
    ...
    babelHelpers.createClass(DataTableController, [{
      ...
      value: function isAllRowsSelected() {
        ...
        return this.options.paging.count ? this.selected.length === parseInt(this.options.paging.count) : this.selected.length === this.rows.length;
      }
    }, {
      key: "onRowsChange",
